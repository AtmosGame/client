    ...
    if (isAuthenticated !== null) {
      if (isAuthenticated === false) {
        ...
        const fetchData = async () => {
          try {
            const response = await axios.get(`/api/verification/${id}/get`, {
              headers: {
    ...
    <div className="mx-auto max-w-[50%] z-50">
      ...
      <div className="backdrop-blur-md bg-white/5 border-[1px] border-white rounded-xl p-8">
        <div>
          ...
          <img src={app.imageUrl} alt={app.name} className="w-48 h-48 object-contain mb-4" />
          ...
          <p className="mb-2">Verification Status: {app.verificationStatus || "Not Verified"}</p>
